...
## O que é o "É vegano?"?
É um software que entrega ao **público vegano** um método prático de consultar quais produtos/marcas são ou não veganos e o porquê. Como adicional, pretendemos informar produtos/promoções perto do usuário.
...
## Ok? Mas cadê o sistema?
O "É vegano?" ainda está em desenvolvimento. Mas aqui estão nossos próximos passo:
